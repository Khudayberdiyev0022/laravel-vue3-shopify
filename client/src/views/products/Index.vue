                      ...
                      <div v-for="product in products" :key="product.id" class="col-xl-4 col-lg-6 col-6">
                        <div class="products-three-single w-100  mt-30">
                                  ...
                                  <div class="quick-view__left-content">
                                    <div class="tabs">
                                      <div class="popup-product-thumb-box">
                                        <ul>
                                          <li v-for="productImage in popupProduct.product_images" :key="productImage.id"
                                      ...
                                      <div class="popup-product-main-image-box">
                                        <div v-for="productImage in popupProduct.product_images" :key="productImage.id" :id="`tabb${productImage.id}`"
                                  ...
                                  <div class="popup-right-content">
                                    ...
                                    <div class="color-varient">
                                      <template v-for="groupProduct in popupProduct.group_products">
                                        <a @click.prevent="getProduct(groupProduct.id)" v-for="color in groupProduct.colors" href="#0" class="color-name" :style="`background: #${color.code}`">
                          ...
                          <div class="products-three-single-content text-center"> <span>Men
                                                            Shoes</span>
                            <h5><a href="shop-details-3.html"> {{ product.category.name }} </a>
                            </h5>
                            <p>
                              <del>$200.00</del>
                              ${{ product.price }}
  ...
  methods: {
    ...
    getProduct(id) {
      this.axios.get(`/products/${id}`)
          .then(response => {
            this.popupProduct = response.data.data
